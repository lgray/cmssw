...
patElectrons = cms.EDProducer("PATElectronProducer",
    ...
    embedParentSuperCluster         = cms.bool(True),  ## embed in AOD externally stored supercluster
    ...
    embedParentBasicClusters        = cms.bool(True),  ## embed in AOD externally stored the electron's pflow basic clusters 
    embedParentPreshowerClusters    = cms.bool(True),  ## embed in AOD externally stored the electron's pflow preshower clusters 
