...
# with command line options: step3 --conditions auto:phase2_realistic -n 10 --era Phase2C2 --eventcontent FEVTDEBUGHLT,MINIAODSIM,DQM --runUnscheduled -s RAW2DIGI,L1Reco,RECO,PAT,VALIDATION:@phase2Validation+@miniAODValidation,DQM:@phase2+@miniAODDQM --datatier GEN-SIM-RECO,MINIAODSIM,DQMIO --customise SLHCUpgradeSimulations/Configuration/combinedCustoms.cust_2023tilted --geometry Extended2023D3 -n 20 --nThreads=4 --no_exec --filein file:step2.root --fileout file:step3.root
...
process.dqmoffline_3_step = cms.EndPath(process.DQMOfflineMiniAOD)
