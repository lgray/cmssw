  ...
  for(unsigned iphot=0;iphot<nphot;++iphot)
    {
      ...
      double HoE1=towerIso1.getTowerESum(&(*PCref->parentSuperCluster()))/PCref->parentSuperCluster()->energy();
      double HoE2=towerIso2.getTowerESum(&(*PCref->parentSuperCluster()))/PCref->parentSuperCluster()->energy(); 
      //cout << "HoE1="<<HoE1<<endl;
      //cout << "HoE2="<<HoE2<<endl;  
