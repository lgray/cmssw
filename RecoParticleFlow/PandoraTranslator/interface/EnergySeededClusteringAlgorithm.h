 ...
 *  $Log: $
 */
#ifndef CMS_ENERGY_SEEDED_CLUSTERING_ALGORITHM_H
#define CMS_ENERGY_SEEDED_CLUSTERING_ALGORITHM_H 1
...
using lc_content_fast::KDTreeLinkerAlgo;
using lc_content_fast::KDTreeNodeInfoT;
...
/**
 *  @brief  EnergySeededClusteringAlgorithm class
 */
class EnergySeededClusteringAlgorithm : public pandora::Algorithm
{
public:
    /**
     ...
     */
    EnergySeededClusteringAlgorithm();
...
inline pandora::Algorithm *EnergySeededClusteringAlgorithm::Factory::CreateAlgorithm() const
{
    return new EnergySeededClusteringAlgorithm();
}

} // namespace cms_content

#endif // #ifndef CMS_ENERGY_SEEDED_CLUSTERING_ALGORITHM_H
