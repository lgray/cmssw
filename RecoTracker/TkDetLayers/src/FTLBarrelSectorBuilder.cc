...
{  
  vector<const GeometricDet*> allGeometricDets = theFTLBarrelSector->components();
  ...
  return new FTLBarrelSector(innerGeomDets,outerGeomDets,innerGeomDetBrothers,outerGeomDetBrothers);
