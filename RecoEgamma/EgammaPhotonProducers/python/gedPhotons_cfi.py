...
gedphotonGBRESSource = cms.ESSource(
    ...
    tag = cms.string('gedphoton_EBCorrection_offline'),
    label = cms.untracked.string('gedphoton_EBCorrection_offline')
    ),
    cms.PSet(
    record = cms.string('GBRWrapperRcd'),
    tag = cms.string('gedphoton_EECorrection_offline'),
    label = cms.untracked.string('gedphoton_EECorrection_offline')
    ),
    cms.PSet(
    record = cms.string('GBRWrapperRcd'),
    tag = cms.string('gedphoton_EBUncertainty_offline'),
    label = cms.untracked.string('gedphoton_EBUncertainty_offline')
    ),
    cms.PSet(
    record = cms.string('GBRWrapperRcd'),
    tag = cms.string('gedphoton_EEUncertainty_offline'),
    label = cms.untracked.string('gedphoton_EEUncertainty_offline')
    ),
    )
)
...
gedphotonPrefer = cms.ESPrefer(
    ...
    GBRWrapperRcd = cms.vstring('GBRForest/gedphoton_EBCorrection_offline',
                                'GBRForest/gedphoton_EECorrection_offline',
                                'GBRForest/gedphoton_EBUncertainty_offline',
                                'GBRForest/gedphoton_EEUncertainty_offline')
)
...
gedPhotons = cms.EDProducer("GEDPhotonProducer",
    ...
    uncertaintyKeyEB = cms.string('pfscecal_EBUncertainty_offline'),
    uncertaintyKeyEE = cms.string('pfscecal_EEUncertainty_offline'),
