#ifndef Geometry_MTDGeometry_CSCChamberSpecs_H
#define Geometry_MTDGeometry_CSCChamberSpecs_H
...
public:
  ...
  CSCChamberSpecs( const ETLGeometry* geom, int iChamberType, 
...
#endif // Geometry_MTDGeometry_CSCChamberSpecs_H
