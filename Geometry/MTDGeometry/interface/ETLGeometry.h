#ifndef MTDGeometry_ETLGeometry_h
#define MTDGeometry_ETLGeometry_h

/** \class ETLGeometry
 *
 *  The model of the geometry of the endcap timing layer detectors.
 *
 *  \author L. Gray - FNAL
 */
...
class ETLGeometry : public TrackingGeometry {
 ...
 public:
  ...
  friend class ETLGeometryBuilder; //FromDDD;
  ...
  /// Real constructor
  ETLGeometry( bool debugV, bool gangedstripsME1a_, bool onlywiresME1a_, bool realWireGeometry_, bool useCentreTIOffsets_ );

  /// Destructor
  ~ETLGeometry() override;
