...
#include <Geometry/MTDGeometry/src/CSCUngangedStripTopology.h>
#include <Geometry/MTDGeometry/src/CSCGangedStripTopology.h>
#include <Geometry/MTDGeometry/src/CSCWireGroupPackage.h>
...
CSCLayerGeometry::CSCLayerGeometry( const ETLGeometry* geom, int iChamberType,
